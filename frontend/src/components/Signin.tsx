...
export  const Signin=()=>{
    const [inputs,setinputs]=useState<SigninBody>({
    ...
    const handlesignup=async()=>{
        const responses=await axios.post("https://backend.sahilkaushik2444.workers.dev/account/signin",inputs);
    ...
    <div className="w-screen h-screen grid grid-cols-1 sm:grid-cols-2">
        <div  className="bg-white flex flex-col justify-center items-center">
            ...
            <div className="flex justify-center">
                 <Head title="Login to account"></Head>
            </div>
